...
void ui_time_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_Roller1, &lv_font_montserrat_28, LV_PART_SELECTED | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_image_src(ui_Button4, &ui_img_362584155, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_image_src(ui_Button5, &ui_img_174066631, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Image4 = lv_image_create(ui_time);
    lv_image_set_src(ui_Image4, &ui_img_1522004715);
    ...
    lv_obj_set_style_bg_color(ui_Image4, lv_color_hex(0xE64500), LV_PART_MAIN | LV_STATE_DEFAULT);
